...
export default function AddHabitForm({ close }: { close: () => void }) {
    ...
    return (
        <div className="hidden fixed inset-0 lg:flex bg-primary-900/20 justify-center items-center  w-full p-3">
            <div ref={ref} className="w-full max-w-[31rem] bg-white shadow rounded-2xl p-8 flex flex-col gap-4">
